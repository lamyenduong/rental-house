          ...
          <div className="relative flex-1 text-center w-1/2 m-auto">
            <div className="w-2/3 mx-auto">
              <ArrowLeft
                ...
                onClick={handleResetClickBack}
              />
            </div>
            <div className="uppercase text-2xl mb-8 mt-10">
              {t(`LoginPage.thirdTitle`)}
            </div>
            <div
              className="w-2/3 text-start mb-4 mx-auto"
              style={{color: Colors.newgrowth}}
            >
              {t(`LoginPage.resetMessage`)}
            </div>
            <div className="mb-5 w-2/3 mx-auto">
              <Input placeholder={t(`InputPlaceholder.email`)} />
            </div>
            <div className="mt-3 w-2/3 mx-auto">
              <Button className="uppercase" variant="default">
                {t(`ButtonLabel.confirm`)}
              </Button>
            </div>
          </div>
        ) : (
